odoo.define('pos_tare.OrderLine', function (require) {
    "use strict";
    ...
    const overloadOrderLine = (Orderline_) =>
        class OrderLineTare extends Orderline_ {
            ...
            export_for_printing() {
                const order_line = super.export_for_printing();
            ...
            set_tare(quantity, update_net_weight) {
                ...
                const tare_in_product_uom_string = pos_tare_tools.format_tare(
                ...
                // todo how does owl manage the triggers ?
